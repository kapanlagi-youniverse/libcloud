...
class GCENodeDriver(NodeDriver):
    ...
    def list_nodes(self, ex_zone=None, use_disk_cache=True):
        """
        ...
        :keyword  use_disk_cache:  Disk information for each node will
            ...
            if zone is None:
                ...
                for v in response['items'].values():
                    for i in v.get('instances', []):
                        try:
                            list_nodes.append(
                                self._to_node(i, use_disk_cache=use_disk_cache)
                            )
    ...
    def create_node(
            ...
            ex_preemptible=None, ex_image_family=None, ex_private_ip=None):
        """
    ...
    def _create_instance_properties(
            ...
            automatic_restart=None, preemptible=None, tags=None, metadata=None,
            description=None, disks_gce_struct=None, nic_gce_struct=None,
            use_selflinks=True, ex_private_ip=None):
        """
